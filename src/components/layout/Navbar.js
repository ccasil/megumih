                ...
                <SideNav style={{ background: 'black', position: 'fixed' }} onSelect={this.onSelect} onToggle={this.onToggle}>
                    ...
                    <SideNav.Nav selected={selected}>
                        <NavItem eventKey="Home">
                            ...
                            <NavText style={{ fontSize: '1.75em' }} title="Home">
                        ...
                        <NavItem eventKey="Magazine">
                            ...
                            <NavText style={{ fontSize: '1.75em' }} title="Magazine">
                        ...
                        <NavItem eventKey="Blog">
                            ...
                            <NavText style={{ fontSize: '1.75em' }} title="Blog">
                                <Link style={{ textDecoration: 'none', color: 'white' }} to="/blog"> Blog </Link>
                            </NavText>
                        </NavItem>
                        <NavItem eventKey="Styling">
                            <NavIcon>
                                {/* <Link style={{ textDecoration: 'none', color: 'white' }} to="/styling"><i className="fas fa-user-tie" style={{ fontSize: '1.75em' }} /></Link> */}
                            </NavIcon>
                            <NavText style={{ fontSize: '1.75em' }} title="Styling">
                                <Link style={{ textDecoration: 'none', color: 'white' }} to="/styling">Styling</Link>
                            </NavText>
                        </NavItem>
                        <NavItem eventKey="Documentary">
                            <NavIcon>
                                {/* <Link style={{ textDecoration: 'none', color: 'white' }} to="/documentary"><i className="fas fa-tv" style={{ fontSize: '1.75em' }} /></Link> */}
                            </NavIcon>
                            <NavText style={{ fontSize: '1.75em' }} title="Documentary">
                                <Link style={{ textDecoration: 'none', color: 'white' }} to="/documentary"> Documentary </Link>
                            </NavText>
                        </NavItem>
                        <NavItem eventKey="About">
                            <NavIcon>
                                {/* <Link style={{ textDecoration: 'none', color: 'white' }} to="/about"><i className="fas fa-female" style={{ fontSize: '1.75em' }} /></Link> */}
                            </NavIcon>
                            <NavText style={{ fontSize: '1.75em' }} title="About">
                                <Link style={{ textDecoration: 'none', color: 'white' }} to="/about"> About </Link>
                            </NavText>
                        </NavItem>
                        <NavItem eventKey="Resume">
                            <NavIcon>
                                {/* <Link style={{ textDecoration: 'none', color: 'white' }} to="/resume"><i className="fas fa-file-alt" style={{ fontSize: '1.75em' }} /></Link> */}
                            </NavIcon>
                            <NavText style={{ fontSize: '1.75em' }} title="Resume">
